...
packages:
  ...
  /babel-jest/29.5.0_@babel+core@7.21.4:
    ...
    dependencies:
      ...
      '@types/babel__core': 7.20.0
      babel-plugin-istanbul: 6.1.1
      babel-preset-jest: 29.5.0_@babel+core@7.21.4
      chalk: 4.1.2
      graceful-fs: 4.2.11
      slash: 3.0.0
    transitivePeerDependencies:
  ...
  /node-jest-badges/1.3.12:
    resolution: {integrity: sha512-xdVZTdjo+yAP6Olo0yskAsYGC7xkWHDEn6JzQ1ikzXLSD5OJU/H6YPJyKPaceCRfckK+kzswznemSgu2PfIgLQ==}
    hasBin: true
    dependencies:
      axios: 1.3.5
      chalk: 4.1.2
