...
const isUndefined = (element) =>
  (element === null || element === void 0 ? void 0 : element.pct) === undefined;
const doBadgesExist = (outputPath) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const exist = yield Promise.all(
      files.map((file) => (0, fs_extra_1.pathExists)(`${outputPath}/${file}`))
    );
...
function generateBadge(settings) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    (0,
    core_1.info)(`🔶 Generating badges from ${summaryPath ? summaryPath : "default coverage summary path"}`);
...
function isJestCoverageReportAvailable(settings) {
  return __awaiter(this, void 0, void 0, function* () {
    const coverageExists = yield (0, fs_extra_1.pathExists)(
      settings.coverageSummaryPath
    );
    if (!coverageExists) {
      return false;
    }
