...
exports.stripProtocolFromUrl =
  exports.suppressSensitiveInformation =
  exports.checkParameters =
  exports.generateFolderPath =
  exports.generateRepositoryPath =
  exports.generateTokenType =
  exports.ssh =
  ...
  return __awaiter(this, void 0, void 0, function* () {
    try {
      if (typeof action.sshKey === "string") {
        ...
        const agentOutput = (0, child_process_1.execFileSync)("ssh-agent")
          .toString()
          .split("\n");
        agentOutput.map((line) => {
          ...
          if (exportableVariables && exportableVariables.length) {
            (0, core_1.exportVariable)(
              exportableVariables[1],
              exportableVariables[2]
            );
          }
        });
        // Adds the SSH key to the agent.
        action.sshKey.split(/(?=-----BEGIN)/).map((line) =>
...
function suppressSensitiveInformation(str, action) {
  let value = str;
  const orderedByLength = [action.token, action.repositoryPath]
    .filter(Boolean)
