...
function generateWorktree(action, worktreedir, branchExists) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      yield (0,
      execute_1.execute)(`git worktree add --no-checkout --detach ${worktreedir}`, action.workspace, action.silent);
      ...
      yield (0,
      execute_1.execute)(checkout.toString(), `${action.workspace}/${worktreedir}`, action.silent);
      if (!branchExists) {
      ...
      throw new Error(
        `There was an error creating the worktree: ${(0,
