...
(function (TestFlag) {
  ...
  TestFlag[(TestFlag["UNABLE_TO_REMOVE_ORIGIN"] = 8)] =
    "UNABLE_TO_REMOVE_ORIGIN";
  TestFlag[(TestFlag["UNABLE_TO_UNSET_GIT_CONFIG"] = 16)] =
    "UNABLE_TO_UNSET_GIT_CONFIG";
  TestFlag[(TestFlag["HAS_REJECTED_COMMIT"] = 32)] = "HAS_REJECTED_COMMIT";
...
exports.action = {
  ...
  email: !(0, util_1.isNullOrUndefined)(
  ...
  repositoryName: !(0, util_1.isNullOrUndefined)(
  ...
  singleCommit: !(0, util_1.isNullOrUndefined)(
    (0, core_1.getInput)("single-commit")
  )
  ...
  targetFolder: !(0, util_1.isNullOrUndefined)(
    (0, core_1.getInput)("target-folder")
  )
    ? (0, core_1.getInput)("target-folder")
    : "badges",
...
(function (DefaultExcludedFiles) {
  ...
  (DefaultExcludedFiles =
    exports.DefaultExcludedFiles || (exports.DefaultExcludedFiles = {}))
);
